...
import '../viewmodels/add_stok_view_model.dart';

class AddStokScreen extends StatelessWidget {
  final Barang barang;
  const AddStokScreen({super.key, required this.barang});
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      builder: (context, _) {
        final vm = Provider.of<AddStokViewModel>(context);
                ...
                child: Form(
                  child: ListView(
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () async {
                          final success = await vm.simpanTambahStok();
                          if (success) {
